...
proc create_root_design { parentCell } {
  ...
  set adc_data_c [ create_bd_port -dir O -from 31 -to 0 adc_data_c ]
  set adc_data_d [ create_bd_port -dir O -from 31 -to 0 adc_data_d ]
  set adc_enable_a [ create_bd_port -dir O adc_enable_a ]
  set adc_enable_b [ create_bd_port -dir O adc_enable_b ]
  set adc_enable_c [ create_bd_port -dir O adc_enable_c ]
  set adc_enable_d [ create_bd_port -dir O adc_enable_d ]
  set adc_valid_a [ create_bd_port -dir O adc_valid_a ]
  set adc_valid_b [ create_bd_port -dir O adc_valid_b ]
  set adc_valid_c [ create_bd_port -dir O adc_valid_c ]
  set adc_valid_d [ create_bd_port -dir O adc_valid_d ]
  ...
  set axi_ddr_cntrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:mig_7series:4.1 axi_ddr_cntrl ]
  ...
  set_property -dict [ list \
   CONFIG.PATH_TO_FILE {/home/bernardo/FPGA/ESTHER_TRIGGER/hdl/projects/fmcjesdadc1/kc705/mem_init_sys.txt} \
   CONFIG.ROM_ADDR_BITS {9} \
 ] $rom_sys_0
  ...
  connect_bd_intf_net -intf_net axi_ad9250_0_dma_m_dest_axi [get_bd_intf_pins axi_ad9250_0_dma/m_dest_axi] [get_bd_intf_pins axi_mem_interconnect/S03_AXI]
  ...
  connect_bd_intf_net -intf_net axi_ad9250_1_dma_m_dest_axi [get_bd_intf_pins axi_ad9250_1_dma/m_dest_axi] [get_bd_intf_pins axi_mem_interconnect/S04_AXI]
  ...
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M11_AXI [get_bd_intf_pins axi_ad9250_xcvr/s_axi] [get_bd_intf_pins axi_cpu_interconnect/M11_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M12_AXI [get_bd_intf_pins axi_ad9250_0_core/s_axi] [get_bd_intf_pins axi_cpu_interconnect/M12_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M13_AXI [get_bd_intf_pins axi_ad9250_1_core/s_axi] [get_bd_intf_pins axi_cpu_interconnect/M13_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M14_AXI [get_bd_intf_pins axi_ad9250_jesd/s_axi] [get_bd_intf_pins axi_cpu_interconnect/M14_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M15_AXI [get_bd_intf_pins axi_ad9250_0_dma/s_axi] [get_bd_intf_pins axi_cpu_interconnect/M15_AXI]
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M16_AXI [get_bd_intf_pins axi_ad9250_1_dma/s_axi] [get_bd_intf_pins axi_cpu_interconnect/M16_AXI]
  ...
  connect_bd_net -net GND_1_dout [get_bd_pins GND_1/dout] [get_bd_pins sys_concat_intc/In2] [get_bd_pins sys_concat_intc/In3] [get_bd_pins sys_concat_intc/In6] [get_bd_pins sys_concat_intc/In7] [get_bd_pins sys_concat_intc/In8] [get_bd_pins sys_concat_intc/In15]
  ...
  connect_bd_net -net axi_ad9250_0_core_adc_data_a [get_bd_ports adc_data_a] [get_bd_pins axi_ad9250_0_core/adc_data_a] [get_bd_pins axi_ad9250_0_cpack/fifo_wr_data_0]
  connect_bd_net -net axi_ad9250_0_core_adc_data_b [get_bd_ports adc_data_b] [get_bd_pins axi_ad9250_0_core/adc_data_b] [get_bd_pins axi_ad9250_0_cpack/fifo_wr_data_1]
  connect_bd_net -net axi_ad9250_0_core_adc_enable_a [get_bd_ports adc_enable_a] [get_bd_pins axi_ad9250_0_core/adc_enable_a] [get_bd_pins axi_ad9250_0_cpack/enable_0]
  connect_bd_net -net axi_ad9250_0_core_adc_enable_b [get_bd_ports adc_enable_b] [get_bd_pins axi_ad9250_0_core/adc_enable_b] [get_bd_pins axi_ad9250_0_cpack/enable_1]
  connect_bd_net -net axi_ad9250_0_core_adc_valid_a [get_bd_ports adc_valid_a] [get_bd_pins axi_ad9250_0_core/adc_valid_a] [get_bd_pins axi_ad9250_0_cpack/fifo_wr_en]
  connect_bd_net -net axi_ad9250_0_core_adc_valid_b [get_bd_ports adc_valid_b] [get_bd_pins axi_ad9250_0_core/adc_valid_b]
  ...
  connect_bd_net -net axi_ad9250_1_core_adc_data_a [get_bd_ports adc_data_c] [get_bd_pins axi_ad9250_1_core/adc_data_a] [get_bd_pins axi_ad9250_1_cpack/fifo_wr_data_0]
  connect_bd_net -net axi_ad9250_1_core_adc_data_b [get_bd_ports adc_data_d] [get_bd_pins axi_ad9250_1_core/adc_data_b] [get_bd_pins axi_ad9250_1_cpack/fifo_wr_data_1]
  connect_bd_net -net axi_ad9250_1_core_adc_enable_a [get_bd_ports adc_enable_c] [get_bd_pins axi_ad9250_1_core/adc_enable_a] [get_bd_pins axi_ad9250_1_cpack/enable_0]
  connect_bd_net -net axi_ad9250_1_core_adc_enable_b [get_bd_ports adc_enable_d] [get_bd_pins axi_ad9250_1_core/adc_enable_b] [get_bd_pins axi_ad9250_1_cpack/enable_1]
  connect_bd_net -net axi_ad9250_1_core_adc_valid_a [get_bd_ports adc_valid_c] [get_bd_pins axi_ad9250_1_core/adc_valid_a] [get_bd_pins axi_ad9250_1_cpack/fifo_wr_en]
  connect_bd_net -net axi_ad9250_1_core_adc_valid_b [get_bd_ports adc_valid_d] [get_bd_pins axi_ad9250_1_core/adc_valid_b]
  ...
  connect_bd_net -net rx_ref_clk_0_1 [get_bd_ports rx_ref_clk_0] [get_bd_pins util_fmcjesdadc1_xcvr/cpll_ref_clk_0] [get_bd_pins util_fmcjesdadc1_xcvr/cpll_ref_clk_1] [get_bd_pins util_fmcjesdadc1_xcvr/cpll_ref_clk_2] [get_bd_pins util_fmcjesdadc1_xcvr/cpll_ref_clk_3] [get_bd_pins util_fmcjesdadc1_xcvr/qpll_ref_clk_0]
  ...
  connect_bd_net -net sys_200m_clk [get_bd_pins axi_ad9250_0_dma/m_dest_axi_aclk] [get_bd_pins axi_ad9250_1_dma/m_dest_axi_aclk] [get_bd_pins axi_ddr_cntrl/ui_clk] [get_bd_pins axi_mem_interconnect/aclk] [get_bd_pins sys_200m_rstgen/slowest_sync_clk]
  connect_bd_net -net sys_200m_reset [get_bd_pins sys_200m_rstgen/peripheral_reset]
  connect_bd_net -net sys_200m_resetn [get_bd_pins axi_ad9250_0_dma/m_dest_axi_aresetn] [get_bd_pins axi_ad9250_1_dma/m_dest_axi_aresetn] [get_bd_pins axi_mem_interconnect/aresetn] [get_bd_pins sys_200m_rstgen/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ad9250_0_dma/m_dest_axi] [get_bd_addr_segs axi_ddr_cntrl/memmap/memaddr] SEG_axi_ddr_cntrl_memaddr
  create_bd_addr_seg -range 0x40000000 -offset 0x80000000 [get_bd_addr_spaces axi_ad9250_1_dma/m_dest_axi] [get_bd_addr_segs axi_ddr_cntrl/memmap/memaddr] SEG_axi_ddr_cntrl_memaddr
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x44A10000 [get_bd_addr_spaces sys_mb/Data] [get_bd_addr_segs axi_ad9250_0_core/s_axi/axi_lite] SEG_data_axi_ad9250_0_core
  create_bd_addr_seg -range 0x00001000 -offset 0x7C420000 [get_bd_addr_spaces sys_mb/Data] [get_bd_addr_segs axi_ad9250_0_dma/s_axi/axi_lite] SEG_data_axi_ad9250_0_dma
  create_bd_addr_seg -range 0x00001000 -offset 0x44A20000 [get_bd_addr_spaces sys_mb/Data] [get_bd_addr_segs axi_ad9250_1_core/s_axi/axi_lite] SEG_data_axi_ad9250_1_core
  create_bd_addr_seg -range 0x00001000 -offset 0x7C430000 [get_bd_addr_spaces sys_mb/Data] [get_bd_addr_segs axi_ad9250_1_dma/s_axi/axi_lite] SEG_data_axi_ad9250_1_dma
  ...
  create_bd_addr_seg -range 0x00002000 -offset 0x40E00000 [get_bd_addr_spaces sys_mb/Data] [get_bd_addr_segs axi_ethernet/S_AXI/Reg] SEG_data_axi_ethernet
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40010000 [get_bd_addr_spaces sys_mb/Data] [get_bd_addr_segs axi_gpio_lcd/S_AXI/Reg] SEG_data_axi_gpio_lcd
  ...
  create_bd_addr_seg -range 0x02000000 -offset 0x60000000 [get_bd_addr_spaces sys_mb/Data] [get_bd_addr_segs axi_linear_flash/S_AXI_MEM/Mem0] SEG_data_axi_linear_flash
