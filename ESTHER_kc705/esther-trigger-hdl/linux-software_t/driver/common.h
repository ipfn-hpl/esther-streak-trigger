...
typedef struct _TRIGGER_SETTING {
  union {
    u32 reg32;
    struct {
      u32 delay : 11, random:1,unused : 20;
    } triggset;
  };
} TRIGGER_SETTING;
...
typedef struct _SHAPI_MOD_DMA_HREGS {
  ...
  volatile u32 triggsetting;       /* offset 0xD0 rw*/
  volatile u32 timer_get;          /* offset 0xD4 ro*/
