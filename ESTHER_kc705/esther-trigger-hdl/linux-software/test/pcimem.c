 ...
 *
 * https://stackoverflow.com/questions/40115097/linux-mmap-access-to-pci-memory-region-from-user-space-application
 *
 *
 */
...
/* Map one page */
  ...
  printf("mmap(%d, %ld, 0x%x, 0x%x, %d, 0x%x)\n", 0, MAP_SIZE,
         PROT_READ | PROT_WRITE, MAP_SHARED, fd, (int)(target & ~MAP_MASK));
